   ...
   // 读取apiUrl
    ...
    chatWindow.on('scroll', function() {
        ...
        if (!isScrolledToBottom) {
            scrollDownBtn.show();
            // 更改为向下的箭头图标和 "下拉到底部" 标题
            scrollDownBtn.html('<div class="_0e98de6"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="9" viewBox="0 0 16 9" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.00008 2.41429C0.609551 2.02376 0.609551 1.3906 1.00008 1.00008C1.3906 0.609551 2.02376 0.609551 2.41429 1.00007L8.00008 6.58586L13.5859 1.00008C13.9764 0.609551 14.6096 0.609551 15.0001 1.00008C15.3906 1.3906 15.3906 2.02376 15.0001 2.41429L8.8486 8.56576C8.37997 9.03439 7.62018 9.03439 7.15155 8.56576L1.00008 2.41429Z" fill="currentColor"></path></svg></div>');
            scrollDownBtn.attr('title', '下拉到底部');
        } else {
            scrollDownBtn.hide();
            // 更改为向上的箭头图标和 "滑动到顶部" 标题
            scrollDownBtn.html('<div class="_0e98de6"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="9" viewBox="0 0 16 9" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.9999 6.58571C15.3904 6.97624 15.3904 7.6094 14.9999 8.00008C14.6094 8.3906 13.9762 8.3906 13.5857 8.00007L7.99992 2.41429L2.41414 8.00008C2.02361 8.3906 1.39045 8.3906 0.999917 8.00008C0.60939 7.6094 0.60939 6.97624 0.999917 6.58571L7.1514 0.434234C7.62003 -0.0343915 8.37982 -0.0343915 8.84845 0.434234L14.9999 6.58571Z" fill="currentColor"></path></svg></div>');
            scrollDownBtn.attr('title', '滑动到顶部');
        }
    });

    // scroll-down 按钮点击事件
    scrollDownBtn.click(function(e) {
        e.preventDefault(); // 阻止默认的 # 链接行为
    ...
    chatWindow.on('click', function() {
        chatWindow.stop(); // 停止 chatWindow 上的所有动画
    });
